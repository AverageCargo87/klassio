...
highlight_region вокруг столбца единиц: x=425, y=170, w=30, h=120, color="#fff59d", duration_ms=4000
wait 4500
...
highlight_region на десятках: x=385, y=170, w=30, h=120, color="#fff59d", duration_ms=4000
wait 4500
...
highlight_region на сотнях: x=345, y=170, w=30, h=120, color="#fff59d", duration_ms=4000
wait 4500
...
- highlight_region для одного разряда (одного столбца цифр) — ширина w=30 (НЕ 40), чтобы соседние не перекрывались по x. Для итогового ответа — шире (w=160-180).
- highlight_region по цветам: разрядные подсветки — мягкий жёлтый "#fff59d", итог — мягкий голубой "#a5f3fc". Не используй насыщенные цвета — это акцент, не плакат.

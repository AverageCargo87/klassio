...
const WARN_UPDATE =
  '[МОДЕРАЦИЯ] Ребёнок грубо выразился. Спокойно и по-доброму скажи, что так говорить нельзя, ' +
  'и что если это повторится — придётся рассказать родителям. Не ругай, не повышай тон, мягко верни к уроку.'

const ESCALATE_UPDATE =
  '[МОДЕРАЦИЯ] Ребёнок грубит повторно. Спокойно скажи, что, как и предупреждала, сообщишь об этом родителям. ' +
  'Можешь предложить сделать короткую паузу и потом продолжить. Сохраняй доброжелательность, не конфликтуй.'

...
console.log('[5/5] Re-fetching agent to confirm...')
{
  ...
  console.log('  tts speed     :', tts.speed, '(target: 0.95 — round 16 slightly slower)')
  ...
  console.log('  pron dicts    :', tts.pronunciation_dictionary_locators?.length || 0,
              'dictionary attached (target: 0 — round 16 disabled klassio-math-ru-v1, dict remains in workspace)')

 ...
 */
export type PresetStyle = 'happy' | 'warm' | 'playful' | 'supportive' | 'sad' | 'angry' | 'distressed';
...
export type DirectorNotes = (DirectorNotesExpressivity & {
    /**
...
export {};
//# sourceMappingURL=DirectorNotes.d.ts.map
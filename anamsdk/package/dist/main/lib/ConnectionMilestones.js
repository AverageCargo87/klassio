...
exports.ClientConnectionMilestoneRecorder = exports.DEFAULT_SLOW_CONNECTION_THRESHOLD_MS = exports.DEFAULT_CONNECTION_MILESTONE_SAMPLE_RATIO = void 0;
const ClientMetrics_1 = require("./ClientMetrics");
exports.DEFAULT_CONNECTION_MILESTONE_SAMPLE_RATIO = 0;
exports.DEFAULT_SLOW_CONNECTION_THRESHOLD_MS = 5000;
class ClientConnectionMilestoneRecorder {
    constructor(options = {}) {
        var _a, _b, _c, _d;
        this.milestones = [];
        this.context = {
        ...
        this.sampleRatio = clampRatio((_b = options.connectionMilestoneSampleRatio) !== null && _b !== void 0 ? _b : exports.DEFAULT_CONNECTION_MILESTONE_SAMPLE_RATIO);
        this.slowConnectionThresholdMs = Math.max(0, finiteNumberOrDefault(options.slowConnectionThresholdMs, exports.DEFAULT_SLOW_CONNECTION_THRESHOLD_MS));
    ...
    publish(reason, tags) {
        ...
        const metrics = [
            {
                name: ClientMetrics_1.ClientMetricMeasurement.CLIENT_METRIC_MEASUREMENT_CONNECTION_MILESTONES,
                value: '1',
                tags: summaryTags,
            },
            ...this.milestones.map((milestone, index) => ({
                name: ClientMetrics_1.ClientMetricMeasurement.CLIENT_METRIC_MEASUREMENT_CONNECTION_MILESTONE,
        ...
        void (0, ClientMetrics_1.sendClientMetrics)(metrics);
    }
    elapsedMs() {
        return Math.max(0, Math.round(this.now() - this.attemptStartedAtMs));
    }
}
exports.ClientConnectionMilestoneRecorder = ClientConnectionMilestoneRecorder;
...
const clampRatio = (value) => {
    const finiteValue = finiteNumberOrDefault(value, exports.DEFAULT_CONNECTION_MILESTONE_SAMPLE_RATIO);

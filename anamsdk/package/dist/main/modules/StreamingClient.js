...
const ToolCallManager_1 = require("./ToolCallManager");
...
class StreamingClient {
    constructor(sessionId, options, publicEventEmitter, internalEventEmitter, toolCallManager, connectionMilestones) {
        ...
        this.signallingClient = new modules_1.SignallingClient(sessionId, options.signalling, this.publicEventEmitter, this.internalEventEmitter, this.apiGatewayConfig, this.connectionMilestones);
    ...
    recordSessionSuccess(detectionMethod) {
        ...
        (0, ClientMetrics_1.sendClientMetric)(ClientMetrics_1.ClientMetricMeasurement.CLIENT_METRIC_MEASUREMENT_SESSION_SUCCESS, '1', { detectionMethod });
    }
    ...
    setupDataChannels() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            dataChannel.onopen = () => {
                ...
                this.publicEventEmitter.emit(types_1.AnamEvent.DATA_CHANNEL_OPEN);
            };
            dataChannel.onclose = () => {
                var _a;
                ...
                try {
                    ...
                    switch (message.messageType) {
                        ...
                        case types_1.DataChannelMessage.USER_SPEECH_ENDED:
                            ...
                            break;
                        case types_1.DataChannelMessage.DIRECTOR_NOTE_CUE_APPLIED:
                            const cueAppliedEvent = message.data;
                            this.publicEventEmitter.emit(types_1.AnamEvent.DIRECTOR_NOTE_CUE_APPLIED, {
                            ...
                            break;
                        case types_1.DataChannelMessage.PERSONA_CONFIG_UPDATE_APPLIED:
                            const updateAppliedEvent = message.data;
                            this.publicEventEmitter.emit(types_1.AnamEvent.PERSONA_CONFIG_UPDATE_APPLIED, {
